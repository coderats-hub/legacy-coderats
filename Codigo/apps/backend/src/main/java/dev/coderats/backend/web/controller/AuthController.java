...
import dev.coderats.backend.infra.cache.EphemeralStore;
...
public class AuthController {
    ...
    public AuthController(AuthService authService, GitHubOAuthClient oauth, EphemeralStore store, UserRepository users) {
